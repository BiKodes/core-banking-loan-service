...
def coverage(c):
    ...
    """
    c.run("coverage run --source core_banking_loan_service runtests.py tests")
...
def lint(c):
    ...
    """
    c.run("flake8 core-banking-loan-service tests")
...
def package(c):
    """
    Packaging core-banking-loan-service and uploading to PyPI.
    """
